        ...
        <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white">
          ...
          <div className="h-0 flex-1 overflow-y-auto pt-5 pb-4">
            ...
            <Link to='/'className="flex items-center ml-4 mt-2">
                ...
                />
                <h3 className="  text-lg inline-flex font-bold leading-6  text-blue-600 mx-4 font-serif uppercase italic ">INFOTECH</h3>
    ...
    <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
      <button onClick={e=>setOpen(true)} className="group block w-full flex-shrink-0">
        <div className="flex items-center">
          ...
          <div className="ml-3">
            <p className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Identificado como : {user && user.email}</p>
