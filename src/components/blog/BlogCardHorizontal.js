              ...
              <div className="flex items-center   my-10 ">
                <div className="lg:flex min-w-0 lg:flex-1 items-center">
                  ...
                  <div className="min-w-0 flex-1 px-8 p-4 ">
                    {
                      ...
                      :
                      <p className="w-full py-2 bg-gray-100 lg:mt-0 lg:absolute lg:top-4 leading-10 text-3xl pb-4 font-semibold transition duration-300 ease-in-out"></p>
                    }
                    ...
                    <div className="lg:absolute lg:top-28">
                  {
                      ...
                      <>
                      <span className=" rounded-full p-1 px-2 bg-green-200 text-green-700  mx-1 font-medium text-sm ">Publish</span> <span className="text-gray-300">&middot;</span>
                      </>
                      :
                      <>
                  ...
                  }
                  {
                    ...
                    <span className=" hover:text-orange-500  mx-1 font-medium text-gray-800 text-sm "><Link to={`/category/${data.category.slug}`}>{data.category.name}</Link></span> <span className="text-gray-300">&middot;</span> 
                        ...
                        <span className="mt-2 ml-2 mr-1 font-medium text-gray-800 text-sm">{moment(data.published).locale('es').format('LL')}</span> <span className="text-gray-300">&middot;</span>
                        <span className="mt-2 mx-2 font-medium text-gray-800 text-sm">{data.time_read} Tiempo de Lectura</span> 
                        {
                          data.description ?
                        ...
                        :
                        <>
                        <p className="animate-pulse w-full py-2 bg-gray-100 mt-4 text-lg font-regular text-gray-800 leading-8"></p>
                        <p className="animate-pulse w-full py-2 bg-gray-100 mt-4 text-lg font-regular text-gray-800 leading-8"></p>
                        <p className="animate-pulse w-full py-2 bg-gray-100 mt-4 text-lg font-regular text-gray-800 leading-8"></p>
                        </>
                        }
